...
public class OutboundController
{
  ...
  {
    final IOutboundTransaction aTx = APMetaJDBCManager.getOutboundTransactionMgr ()
  ...
  {
    final var aTxs = APMetaJDBCManager.getOutboundTransactionMgr ().getAllInTransmission ();
